 ...
 *
 * Ported from `scripts/FollowController.gd`. The Godot version also carried `navigate_sequence`
 * and the arrow drawing; those belong with NAV-103's `point_to`, which is what will use them.
 */
